                ...
                if data == []:
                    ...
                    try:
                        for n in range(0,max):
                            ...
                            if response == {"mess": "Thành công, bạn đã được cộng 600 xu"}:
                                coin += 600
                                self.tong_jobs += 1
                                print(f"{colorama.Fore.GREEN}{self.tong_jobs}|{colorama.Fore.YELLOW}{time.strftime("%H:%M:%S", time.localtime())}{colorama.Fore.GREEN}|{colorama.Fore.RED}{user}{colorama.Fore.GREEN}|{colorama.Fore.CYAN}{coin}{colorama.Fore.GREEN}|+600|{colorama.Fore.MAGENTA}LIKE RE")
                                delay(randint(30,60))
                    ...
                    try:
                        for n in range(0,max):
                            ...
                            if response == {"mess": "Thành công, bạn đã được cộng 600 xu"}:
                                coin += 600
                                self.tong_jobs += 1
                                print(f"{colorama.Fore.GREEN}{self.tong_jobs}|{colorama.Fore.YELLOW}{time.strftime("%H:%M:%S", time.localtime())}{colorama.Fore.GREEN}|{colorama.Fore.RED}{user}{colorama.Fore.GREEN}|{colorama.Fore.CYAN}{coin}{colorama.Fore.GREEN}|+600|{colorama.Fore.MAGENTA}CX RE")
                                delay(randint(30,60))
                ...
                if data == []:
                    ...
                    try:
                        for n in range(0,max):
                            ...
                            self.FB.auto_comment(cookie_facebook, idfb, proxies = proxies)
                            response = self.TTC.get_coin_jobs_comment(idpost,cookie)
                            if response == {"mess": "Thành công, bạn đã được cộng 1400 xu"}:
                                coin += 1400
                                self.tong_jobs += 1
